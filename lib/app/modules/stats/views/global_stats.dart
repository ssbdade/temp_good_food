...
class GlobalStatsView extends GetView<StatsController> {
  const GlobalStatsView({Key? key}) : super(key: key);
  @override
          ...
          children: [
            Expanded(
              child: statsContainer(
                  ...
                  amount: controller.formatter.format(controller.globalCase.affectedAmount),
            ...
            Expanded(child: statsContainer(
                ...
                amount: controller.formatter.format(controller.globalCase.deathAmount),
                amountStyle: Theme.of(context).textTheme.subtitle2!.copyWith(
                  color: AppColors.white,
                  fontSize: size(24),
                  fontWeight: FontWeight.w600,
          ...
          children: [
            Expanded(
              child: statsContainer(
                ...
                amount: controller.formatter.format(controller.globalCase.recoveredAmount),
              ),
            ),
            SizedBox(
              width: 16.w,
            ...
            Expanded(
              child: statsContainer(
                ...
                amount: controller.formatter.format(controller.globalCase.activeAmount),
              ),
            ),
            SizedBox(
              width: 16.w,
            ...
            Expanded(child: statsContainer(
              ...
              amount: controller.formatter.format(controller.globalCase.seriousAmount),
            ),),
          ],
        ),
      ],
